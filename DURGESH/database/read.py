...
CAPTIONS = [
"**Aʟʟ Is Bᴜᴛ A Dʀᴇᴀᴍ :)**",
"**Rᴇᴀʟɪᴛʏ Is Mᴇʀᴇʟʏ Pᴇʀᴄᴇɪᴠᴇᴅ :)**",
"**Tʜᴇ Wᴏʀʟᴅ Is A Mɪʀᴀɢᴇ :)**",
"**Eᴠᴇʀʏᴛʜɪɴɢ Is A Fᴀᴄᴀᴅᴇ :)**",
"**Lɪғᴇ Is Aɴ Iʟʟᴜsɪᴏɴ :)**",
"**Pᴇʀᴄᴇᴘᴛɪᴏɴ Sʜᴀᴘᴇs Rᴇᴀʟɪᴛʏ :)**",
"**Tʜᴇ Tʀᴜᴛʜ Is Hɪᴅᴅᴇɴ :)**",
"**Aʟʟ Is Eᴘʜᴇᴍᴇʀᴀʟ :)**",
"**Rᴇᴀʟɪᴛʏ Is A Cᴏɴsᴛʀᴜᴄᴛ :)**",
"**Tʜᴇ Wᴏʀʟᴅ Is A Sᴛᴀɢᴇ :)**",
"**Eᴠᴇʀʏᴛʜɪɴɢ Is Tʀᴀɴsɪᴇɴᴛ :)**",
"**Aᴘᴘᴇᴀʀᴀɴᴄᴇs Dᴇᴄᴇɪᴠᴇ :)**",
"**Lɪғᴇ Is A Pʟᴀʏ Oғ Sʜᴀᴅᴏᴡs :)**",
"**Tʜᴇ Tʀᴜᴛʜ Is Eʟᴜsɪᴠᴇ :)**",
"**Rᴇᴀʟɪᴛʏ Is A Vᴇɪʟ :)**",
"**Eᴠᴇʀʏᴛʜɪɴɢ Is A Mɪʀᴀɢᴇ :)**",
"**Tʜᴇ Wᴏʀʟᴅ Is A Dʀᴇᴀᴍ :)**",
"**Pᴇʀᴄᴇᴘᴛɪᴏɴ Is Rᴇᴀʟɪᴛʏ :)**",
"**Lɪғᴇ Is A Fʟᴇᴇᴛɪɴɢ Mᴏᴍᴇɴᴛ :)**",
"**Tʜᴇ Tʀᴜᴛʜ Is Aɴ Iʟʟᴜsɪᴏɴ :)**",
...
"""
CAPTIONS = [
"Aʟʟ Is Bᴜᴛ A Dʀᴇᴀᴍ :)", "Rᴇᴀʟɪᴛʏ Is Mᴇʀᴇʟʏ Pᴇʀᴄᴇɪᴠᴇᴅ :)", 
"Tʜᴇ Wᴏʀʟᴅ Is A Mɪʀᴀɢᴇ :)", "Eᴠᴇʀʏᴛʜɪɴɢ Is A Fᴀᴄᴀᴅᴇ :)",
"Lɪғᴇ Is Aɴ Iʟʟᴜsɪᴏɴ :)", "Pᴇʀᴄᴇᴘᴛɪᴏɴ Sʜᴀᴘᴇs Rᴇᴀʟɪᴛʏ :)", 
"Tʜᴇ Tʀᴜᴛʜ Is Hɪᴅᴅᴇɴ :)", "Aʟʟ Is Eᴘʜᴇᴍᴇʀᴀʟ :)", 
"Rᴇᴀʟɪᴛʏ Is A Cᴏɴsᴛʀᴜᴄᴛ :)", "Tʜᴇ Wᴏʀʟᴅ Is A Sᴛᴀɢᴇ :)", 
"Eᴠᴇʀʏᴛʜɪɴɢ Is Tʀᴀɴsɪᴇɴᴛ :)", "Aᴘᴘᴇᴀʀᴀɴᴄᴇs Dᴇᴄᴇɪᴠᴇ :)", 
"Lɪғᴇ Is A Pʟᴀʏ Oғ Sʜᴀᴅᴏᴡs :)", "Tʜᴇ Tʀᴜᴛʜ Is Eʟᴜsɪᴠᴇ :)",
"Rᴇᴀʟɪᴛʏ Is A Vᴇɪʟ :)", "Eᴠᴇʀʏᴛʜɪɴɢ Is A Mɪʀᴀɢᴇ :)", 
"Tʜᴇ Wᴏʀʟᴅ Is A Dʀᴇᴀᴍ :)", "Pᴇʀᴄᴇᴘᴛɪᴏɴ Is Rᴇᴀʟɪᴛʏ :)", 
